...
@rfm.parameterized_test(*[[pe, cuda]
  for pe in [
#no-libsci:    ['dom', 'PrgEnv-gnu', 'gcc/6.1.0'],
    ...
    # ['dom', 'PrgEnv-cray', 'cce/90-classic.newest'],
#no-mpi:    ['dom', 'PrgEnv-cray', 'cce/90.newest'],
...
#no-mpich:    ['daint', 'PrgEnv-cray', 'cce/8.5.5'],
...
[       OK ] openmpGPU_10.0_dom_cce8.7.10 on dom:gpu using PrgEnv-cray
[       OK ] openmpGPU_10.0_dom_cce90-classic.newest on dom:gpu using PrgEnv-cray
--- daint:
[       OK ] openmpGPU_8.0._daint_cce8.7.4 on daint:gpu using PrgEnv-cray
[       OK ] openmpGPU_8.0._daint_cce8.6.1 on daint:gpu using PrgEnv-cray

[       OK ] openmpGPU_9.2._daint_cce8.7.4 on daint:gpu using PrgEnv-cray
[       OK ] openmpGPU_9.2._daint_cce8.6.1 on daint:gpu using PrgEnv-cray
    -----------------
    ...
    # def __init__(self, sysname, prgenv, compilerversion):
        ...
        try:
            ...
            cudashortver = "10.0"
            # cudashortver = os.environ['CRAY_CUDATOOLKIT_VERSION']
        self.name = 'openmpGPU_' + cudashortver + "_" + sysname + "_" + \
        ...
        self.sourcesdir = os.path.join('src')
...
#            'LIB=-lstdc++']
        ...
        self.testname = 'offloading_success'
