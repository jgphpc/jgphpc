...
# ---- step1 = get the mask:
# for i in `seq 0 35`;do e -n $i = ; srun --cpu_bind=v,map_cpu:$i hostname ;done |grep -v ^nid
    # 0 =cpu-bind=MAP  - nid00404, task  0  0 [66170]: mask 0x1 set
	# 1 =cpu-bind=MAP  - nid00404, task  0  0 [64308]: mask 0x2 set
	# 2 =cpu-bind=MAP  - nid00404, task  0  0 [64323]: mask 0x4 set
	# 3 =cpu-bind=MAP  - nid00404, task  0  0 [64339]: mask 0x8 set
	# 4 =cpu-bind=MAP  - nid00404, task  0  0 [64355]: mask 0x10 set
	# 5 =cpu-bind=MAP  - nid00404, task  0  0 [64370]: mask 0x20 set
	# 6 =cpu-bind=MAP  - nid00404, task  0  0 [64386]: mask 0x40 set
	# 7 =cpu-bind=MAP  - nid00404, task  0  0 [64402]: mask 0x80 set
	# 8 =cpu-bind=MAP  - nid00404, task  0  0 [64418]: mask 0x100 set
	# 9 =cpu-bind=MAP  - nid00404, task  0  0 [64434]: mask 0x200 set
	# 10 =cpu-bind=MAP  - nid00404, task  0  0 [64450]: mask 0x400 set
	# 11 =cpu-bind=MAP  - nid00404, task  0  0 [64465]: mask 0x800 set
	# 12 =cpu-bind=MAP  - nid00404, task  0  0 [64484]: mask 0x1000 set
	# 13 =cpu-bind=MAP  - nid00404, task  0  0 [64499]: mask 0x2000 set
	# 14 =cpu-bind=MAP  - nid00404, task  0  0 [64515]: mask 0x4000 set
	# 15 =cpu-bind=MAP  - nid00404, task  0  0 [64531]: mask 0x8000 set
	# 16 =cpu-bind=MAP  - nid00404, task  0  0 [64547]: mask 0x10000 set
	# 17 =cpu-bind=MAP  - nid00404, task  0  0 [64562]: mask 0x20000 set
	# 18 =cpu-bind=MAP  - nid00404, task  0  0 [64579]: mask 0x40000 set
	# 19 =cpu-bind=MAP  - nid00404, task  0  0 [64594]: mask 0x80000 set
	# 20 =cpu-bind=MAP  - nid00404, task  0  0 [64609]: mask 0x100000 set
	# 21 =cpu-bind=MAP  - nid00404, task  0  0 [64626]: mask 0x200000 set
	# 22 =cpu-bind=MAP  - nid00404, task  0  0 [64642]: mask 0x400000 set
	# 23 =cpu-bind=MAP  - nid00404, task  0  0 [64657]: mask 0x800000 set
	# 24 =cpu-bind=MAP  - nid00404, task  0  0 [64673]: mask 0x1000000 set
	# 25 =cpu-bind=MAP  - nid00404, task  0  0 [64689]: mask 0x2000000 set
	# 26 =cpu-bind=MAP  - nid00404, task  0  0 [64705]: mask 0x4000000 set
	# 27 =cpu-bind=MAP  - nid00404, task  0  0 [64722]: mask 0x8000000 set
	# 28 =cpu-bind=MAP  - nid00404, task  0  0 [64738]: mask 0x10000000 set
	# 29 =cpu-bind=MAP  - nid00404, task  0  0 [64772]: mask 0x20000000 set
	# 30 =cpu-bind=MAP  - nid00404, task  0  0 [65123]: mask 0x40000000 set
	# 31 =cpu-bind=MAP  - nid00404, task  0  0 [65141]: mask 0x80000000 set
	# 32 =cpu-bind=MAP  - nid00404, task  0  0 [65156]: mask 0x100000000 set
	# 33 =cpu-bind=MAP  - nid00404, task  0  0 [65173]: mask 0x200000000 set
	# 34 =cpu-bind=MAP  - nid00404, task  0  0 [65189]: mask 0x400000000 set
	# 35 =cpu-bind=MAP  - nid00404, task  0  0 [65206]: mask 0x800000000 set
# ----
# for i in `awk '{print $11}' masks`;do e -n $i =; srun --cpu_bind=v,mask_cpu:$i bash ./0.sh ;done
	# 0x1 =cpu-bind=MASK - nid00404, task  0  0 [70279]: mask 0x1 set
	# 0x2 =cpu-bind=MASK - nid00404, task  0  0 [70299]: mask 0x2 set
    # etc...
# ----
